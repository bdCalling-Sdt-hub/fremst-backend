...
const createQuestionCategoryZodSchema = z.object({
  body: z.object({
    name: z.string({
...
const updateQuestionCategoryZodSchema = z.object({
  body: z.object({
    name: z
...
export const QuestionCategoryValidation = {
  createQuestionCategoryZodSchema,
  updateQuestionCategoryZodSchema,
};
