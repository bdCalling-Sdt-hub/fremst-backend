import { StatusCodes } from 'http-status-codes';
  ...
  const getAllEmployees = async (queryFields: Record<string, any>): Promise<IEmployee[]> => {
  ...
  const updateEmployee = async (id: string, payload: IEmployee): Promise<IEmployee | null> => {
